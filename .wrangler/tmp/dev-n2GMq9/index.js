...
var app = new Hono2();
app.use("/api/*", cors());
var DATA_WORKER_BASE = "https://singularity-server.devxoshakya.workers.dev";
var analyticsTools = [{
...
app.get("/api/query", async (c) => {
  ...
  try {
    ...
    c.executionCtx.waitUntil(
      KV.put(userQuery, JSON.stringify(finalPayload), { expirationTtl: 5184e3 })
    );
...
// ../.nvm/versions/node/v24.13.1/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../.nvm/versions/node/v24.13.1/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-jlEOKC/middleware-insertion-facade.js
...
// ../.nvm/versions/node/v24.13.1/lib/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-jlEOKC/middleware-loader.entry.ts
